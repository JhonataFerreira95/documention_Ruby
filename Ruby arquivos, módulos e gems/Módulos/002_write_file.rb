...
File.open("../Manipulação de arquivos/Text/courses.txt", "w") do |file| # Arquivo <data> não existe AINDA. Quando passamo o <"w"> significa que quero trabalha com (write == escrever) no ruby. 
