...
def search(key) # Criação do metódo com parâmentro.
  Dir.glob("../Manipulação de arquivos/Text/*.txt") do |file| # Ussamos o <Dir.glob> para abrir o diretório, com <do> iniciamos um bloco que passamos a nossa variãvel entre os pipes <|file>.
